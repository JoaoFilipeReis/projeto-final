...
<div>
    ...
    <div class="container">
        <div class="col-10 mx-auto">
            ...
            <div class="row noticias-conteudo d-flex justify-content-center p">
                <img class="mb-5" src="./public/imagens-desktop/conteudo-imprensa1.jpg" style="width: 100%; height: 100%;" alt="Imagem">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-10 mx-auto">
            ...
            <div class="row noticias-conteudo d-flex justify-content-center">
                ...
                <img class="mb-5" src="./public/imagens-desktop/conteudo-imprensa2.jpg" style="width: 100%; height: 100%;" alt="Imagem">
        ...
        <div class="container" style="margin-top: 85px;">
            <div class="row text-center">
                <div class="col-auto d-flex flex-columns flex-nowrap mx-auto">
                    <a class="paginacao-link" href="https://sebastiaoalves.com/imprensa/1">
                        <div id="seta-esquerda" class="setas-paginacao"></div>
                    </a>
                    <a class="paginacao-link" href="https://sebastiaoalves.com/imprensa/1">
                        <div class="paginacao active">1</div>
                    </a>
                    <a class="paginacao-link" href="https://sebastiaoalves.com/imprensa/2">
                        <div class="paginacao ">2</div>
                    </a>
                    <a class="paginacao-link" href="https://sebastiaoalves.com/imprensa/3">
                        <div class="paginacao ">3</div>
                    </a>
                    <a class="paginacao-link" href="https://sebastiaoalves.com/imprensa/2">
...
-->
        ...
        <div class="container" style="margin-top: 85px;">
            <div class="row text-center">
                <div class="col-auto d-flex flex-nowrap mx-auto">
