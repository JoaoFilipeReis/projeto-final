    ...
    <div>
        <div class="container-fluid">
            <div id="caixa-topo" class="row offset-md-1 pt-1 pl-4">
                ...
                <div class="w-100"></div>
                <div class="col destaques-titulo mt-2 ml-2 ml-md-5 mb-3">O Caracol Estrábico</div>
            </div>
        </div>
        ...
        <div class="container" style="margin-top: 65px;">
            <div class="row d-flex">
                <div id="caixa-capa-livro" class="col-12 col-lg-5 d-flex justify-content-center">
                    <img id="capa-livro" class="row capa-livro" src="./public/imagens-desktop/livro-conteudo3.jpg" alt="O Caracol Estrábico">
                </div>
                <div id="caixa-texto-livro-lateral" class="col-12 col-lg-7">
                    ...
                    <div>Edição: Agosto de 2011</div>
                    <div>Dimensões: 143 x 220 x 14 mm</div>
